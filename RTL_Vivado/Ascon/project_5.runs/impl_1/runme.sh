...
HD_PWD='E:/ascon_debugger/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ascon_Top_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ascon_Top_tb.tcl -notrace
