...
HD_PWD='E:/ascon_debugger/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ascon_Top_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ascon_Top_tb.tcl
